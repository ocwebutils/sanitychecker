<template>
	<div class="flex justify-center items-center">
		<div class="flex p-4 mt-3 mx-4 text-sm text-blue-700 bg-blue-200 rounded-lg dark:bg-blue-200 dark:text-blue-800 max-w-3xl" role="alert">
			...
			<div>
				...
				<p>
					...
					<a href="https://ocutils.me/discord" class="font-bold text-blue-800 dark:text-blue-900">discord server</a> for updates :)
				</p>
			</div>
		</div>
	</div>
